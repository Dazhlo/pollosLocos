			...
			<div class="w-full xl:w-3/4 lg:w-11/12 flex">
				...
				<div class="w-full lg:w-7/12 bg-white dark:bg-gray-700 p-5 rounded-lg lg:rounded-l-none">
					...
					<form class="px-8 pt-6 pb-8 mb-4 bg-white dark:bg-gray-800 rounded">
						<div class="mb-4 md:flex md:justify-between">
							<div class="mb-4 md:mr-2 md:mb-0">
								...
								<input
                                    ...
                                    type="text"
                                    placeholder="First Name" value="{{$cliente ->nombre}}"
                                />
							</div>
							<div class="md:ml-2">
								...
								<input
                                   ...
                                   name="apellidos" id="apellidos"
                                    type="text"
                                    placeholder="Apelldps"value="{{$cliente ->apellidos}}"
                                />
							</div>
						</div>
						<div class="mb-4">
						...
						<div class="mb-4 md:flex md:justify-between">
							<div class="mb-4 md:mr-2 md:mb-0">
								...
								<input
                                    ...
                                    placeholder="******************"value="{{$cliente ->contraseña}}"
                                />
								<p class="text-xs italic text-red-500">Please choose a password.</p>
							</div> 
						 {{-- input imagen <img src="" alt=""> no poner requed  --}}
						</div>
						...
						<a href="/cliente/mostrar/{id}">Ver informacion</a>
						<div> <h4>Imagen</h4>
							<img src="{{$cliente ->imagen}}" alt="{{$cliente ->imagen}} " width="100px">
						</div>
